...
class _DenseLayer(nn.Sequential):
    ...
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):
        ...
        self.add_module("att", attention(num_input_features))
        self.add_module("norm1", nn.BatchNorm2d(num_input_features))
        self.add_module("relu1", nn.ReLU(inplace=True))
        self.add_module("conv1", nn.Conv2d(num_input_features, bn_size * growth_rate,
                                           kernel_size=1, stride=1, bias=False))
        #self.add_module("att", attention(bn_size * growth_rate))
        # self.add_module("conv1", nn.Conv2d(num_input_features, bn_size * growth_rate,
        ...
        #self.add_module("att", attention(growth_rate))
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 32, 32), num_init_features=64,
