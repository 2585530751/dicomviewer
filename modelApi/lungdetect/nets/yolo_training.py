...
class YOLOLoss(nn.Module):
    def __init__(self, anchors, num_classes, input_shape, cuda, anchors_mask = [[2], [1], [0]], label_smoothing = 0, focal_loss = False, alpha = 0.25, gamma = 2):
        super(YOLOLoss, self).__init__()
        #-----------------------------------------------------------#
        #   13x13的特征层对应的anchor是[142, 110],[192, 243],[459, 401]  [17,17]
        #   26x26的特征层对应的anchor是[36, 75],[76, 55],[72, 146]   [8,8]
        #   52x52的特征层对应的anchor是[12, 16],[19, 36],[40, 28]   [4,4]
        #-----------------------------------------------------------#
