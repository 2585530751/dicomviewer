...
@Service("intestinalPolypsSegment")
public class IntestinalPolypsSegmentModel implements ModelApiService {
    ...
    public String postModel(String filePath) {
        ...
        // 请求地址
        String url = modelUrl + "/model/intestinalPolypsSegment";
        // 请求头设置
        ...
        if(entity != null){
            try{
                ...
                path = FileUtil.saveFile(tempFile, MyConstant.IMAGE_SEG_DIR, basePath);
            }catch (IOException e){
                e.printStackTrace();
                return null;
            }finally {
